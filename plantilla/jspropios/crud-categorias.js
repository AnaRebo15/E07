    ...
    $.ajax({ 
        ...
        success: function( respuesta ) {
          ...
          if(JSONRespuesta.estado==1){
            ...
            let Botones="";
            if(tieneSubcategorias){
                Botones = '<a class="btn btn-warning btn-sm" href="#" data-toggle="modal" data-target="#modal-lg-subtemas"><i class="fas fa-clock"></i></a>';
      ...
      if(JSONRespuesta.estado==1){
        ...
        tabla = $("#example1").DataTable();
            ...
            JSONRespuesta.categorias.forEach(categoria => {
              ...
              tabla.row.add([categoria.nombrecategoria, etiquetaSubcategoria, Botones]).draw().node().id="renglon_"+categoria.id;
            });
      } 
      console.log(respuesta);
    }
    ...
    success: function( respuesta ) {
      ...
      if(JSONRespuesta.estado==1){
        ...
        if(tieneSubcategorias==1){
          Botones = '<a class="btn btn-warning btn-sm" href="#" data-toggle="modal" data-target="#modal-lg-subtemas"><i class="fas fa-clock"></i></a>';
          Botones += ' <a class="btn btn-primary btn-sm" href="#" data-toggle="modal" data-target="#modal-update" onclick="identificarActualizar('+idActualizar+');"><i class="fas fa-edit"></i></a>';
          Botones += ' <a class="btn btn-danger btn-sm" href="#" data-toggle="modal" data-target="#modal-delete" onclick="identificarEliminar('+idActualizar+');"><i class="fas fa-trash"></i></a>';
        }
        else{
            Botones = ' <a class="btn btn-primary btn-sm" href="#" data-toggle="modal" data-target="#modal-update" onclick="identificarActualizar('+idActualizar+');"><i class="fas fa-edit"></i></a>';
            Botones += ' <a class="btn btn-danger btn-sm" href="#" data-toggle="modal" data-target="#modal-delete" onclick="identificarEliminar('+idActualizar+');"><i class="fas fa-trash"></i></a>';
